...
const principal = (permission: 'roles.manage' | 'api_keys.create' | 'api_keys.revoke'): Principal => ({ user_id: 'usr_1', display_name: '管理员', email: null, auth_method: 'local', is_emergency_admin: false, has_high_risk_role: false, system_permissions: [permission], model_permissions: [], config_namespace_permissions: [] })
