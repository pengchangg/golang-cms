import { ApiOutlined, ArrowRightOutlined, ControlOutlined, DatabaseOutlined, FileImageOutlined, KeyOutlined, SafetyCertificateOutlined, TeamOutlined } from '@ant-design/icons'
...
export default function WorkspacePage({ principal }: { principal: Principal }) {
  const icons = { users: <TeamOutlined />, roles: <SafetyCertificateOutlined />, models: <DatabaseOutlined />, configurations: <ControlOutlined />, assets: <FileImageOutlined />, 'api-keys': <KeyOutlined />, 'api-explorer': <ApiOutlined /> }
