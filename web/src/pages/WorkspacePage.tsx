import { ArrowRightOutlined, DatabaseOutlined, FileImageOutlined, KeyOutlined, SafetyCertificateOutlined, TeamOutlined } from '@ant-design/icons'
...
export default function WorkspacePage({ principal }: { principal: Principal }) {
  const icons = { users: <TeamOutlined />, roles: <SafetyCertificateOutlined />, models: <DatabaseOutlined />, assets: <FileImageOutlined />, 'api-keys': <KeyOutlined /> }
