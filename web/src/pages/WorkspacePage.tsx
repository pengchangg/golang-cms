import { ArrowRightOutlined, DatabaseOutlined, KeyOutlined, SafetyCertificateOutlined, TeamOutlined } from '@ant-design/icons'
...
export default function WorkspacePage({ principal }: { principal: Principal }) {
  const icons = { users: <TeamOutlined />, roles: <SafetyCertificateOutlined />, models: <DatabaseOutlined />, 'api-keys': <KeyOutlined /> }
