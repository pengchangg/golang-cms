import { ArrowRightOutlined, DatabaseOutlined, FileImageOutlined, KeyOutlined, SafetyCertificateOutlined, SwapOutlined, TeamOutlined } from '@ant-design/icons'
...
export default function WorkspacePage({ principal }: { principal: Principal }) {
  const icons = { users: <TeamOutlined />, roles: <SafetyCertificateOutlined />, models: <DatabaseOutlined />, assets: <FileImageOutlined />, jobs: <SwapOutlined />, 'api-keys': <KeyOutlined /> }
